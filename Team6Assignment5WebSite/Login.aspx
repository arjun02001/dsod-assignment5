    ...
    <div>
        ...
        <asp:Table runat="server" Width="100%">
            ...
            <asp:TableRow ID="TableRow2" runat="server">
                <asp:TableCell ID="TableCell3" runat="server" Height="80px" VerticalAlign="Bottom" HorizontalAlign="Right">
                    <asp:Label ID="Label1" runat="server">Email: </asp:Label>
                </asp:TableCell>
                <asp:TableCell ID="TableCell5" runat="server" Height="80px" VerticalAlign="Bottom" HorizontalAlign="Left">
        ...
        <asp:Table runat="server" Width="100%">
            <asp:TableRow ID="TableFooterRow1" runat="server">
                <asp:TableCell ID="TableCell4" runat="server" style="font-size:14px;" padding-top="80px" HorizontalAlign="Center" Height="100px">
